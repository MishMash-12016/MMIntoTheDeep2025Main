...
public class AutoSample7 extends MMOpMode {
    ...
    public void onInit() {
        ...
        new SequentialCommandGroup(
                ...
                new ActionCommand(driveToScorePreloadSample),
                AutoSpecimensCommand.SpecimenScorePreLoad(),
                new ActionCommand(driveToIntakeFirstSample),
                ...
                new ActionCommand(driveToScoreFirstSample),
                new ActionCommand(driveToSecondSample),
                IntakeSampleCommand.prepareSampleIntakeWithoutButton(),
                MMRobot.getInstance().mmSystems.intakeEndUnitRotator.setPosition(0.35),
                new WaitCommand(400),
                IntakeSampleCommand.SampleIntake(),
                new ActionCommand(driveToIntakeThird),
                IntakeSampleCommand.prepareSampleIntakeWithoutButton(),
                MMRobot.getInstance().mmSystems.intakeEndUnitRotator.setPosition(0.25),
                new WaitCommand(400),
                IntakeSampleCommand.SampleIntake(),
                new ActionCommand(driveToScoreThird),
                new ActionCommand(driveToIntakeForth),
                IntakeSampleCommand.prepareSampleIntakeWithoutButton(),
                new WaitCommand(400),
                IntakeSampleCommand.SampleIntake(),
                new ActionCommand(driveToScoreForth),
                new ActionCommand(driveToIntakeFifth),
                IntakeSampleCommand.prepareSampleIntakeWithoutButton(),
                new WaitCommand(400),
                IntakeSampleCommand.SampleIntake(),
                new ActionCommand(driveToScoreFifth),
                new ActionCommand(driveToIntakeSixth),
                IntakeSampleCommand.prepareSampleIntakeWithoutButton(),
                new WaitCommand(400),
                IntakeSampleCommand.SampleIntake(),
                new ActionCommand(driveToScoreSixth),
                new ActionCommand(driveToPark)
        ).schedule();
