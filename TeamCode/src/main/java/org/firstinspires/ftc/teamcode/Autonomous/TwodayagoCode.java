...
@Autonomous
public class TwodayagoCode extends MMOpMode {
    MMRobot robotInstance;

    public TwodayagoCode() {
    ...
    public void onInit() {
        ...
        TrajectoryActionBuilder driveToPush1 = driveToScorePreloadSpecimen.endTrajectory().fresh()
                ...
                .splineToSplineHeading(pushSamplePos, Math.toRadians(0),new TranslationalVelConstraint(MecanumDrive.PARAMS.maxWheelVel * 0.5));
