...
@Autonomous
public class AutoOnePlusFiveLeftBlue extends MMOpMode {
    ...
    public AutoOnePlusFiveLeftBlue() {
    ...
    public void onInit() {
        ...
        TrajectoryActionBuilder driveToScorePreload = drive.actionBuilder(currentPose)
                ...
                .splineToConstantHeading(new Vector2d(-5, -28), Math.toRadians(90), new TranslationalVelConstraint(MecanumDrive.PARAMS.maxWheelVel * 1.5), new ProfileAccelConstraint(MecanumDrive.PARAMS.minProfileAccel * 1.5, MecanumDrive.PARAMS.maxProfileAccel));
