...
public class TrialAutoSample extends MMOpMode {
    ...
    public void onInit() {
        ...
        TrajectoryActionBuilder driveToScoreFirstSample = midLimeLightFirst.endTrajectory().fresh()
        ...
        TrajectoryActionBuilder midLimeLightForth = driveToIntakeForth.endTrajectory().fresh();

        TrajectoryActionBuilder driveToScoreForth = midLimeLightForth.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(-64.9, -49), Math.toRadians(-100.67));
