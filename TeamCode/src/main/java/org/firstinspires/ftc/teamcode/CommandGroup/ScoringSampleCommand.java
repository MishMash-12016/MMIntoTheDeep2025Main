...
public class ScoringSampleCommand {
    public static Command PrepareHighSampleEran(){
        return new SequentialCommandGroup(
                ...
                new WaitCommand(100),
                MMRobot.getInstance().mmSystems.scoringArm.setPosition(ScoringArmState.SCORE_ARM_SCORE_SAMPLE),
                new WaitCommand(100),
    ...
    public static Command PrepareHighSample(){
        return new SequentialCommandGroup(
                ...
                new WaitCommand(100),
                new ParallelCommandGroup(
                        MMRobot.getInstance().mmSystems.elevator.moveToPose(ElevatorState.HIGH_BASKET.position.get()+1).alongWith(
    ...
    public static Command PrepareHighSample_Auto(){
        return new SequentialCommandGroup(
                ...
                new ParallelCommandGroup(
                        ...
                        MMRobot.getInstance().mmSystems.elevator.moveToPose(ElevatorState.HIGH_BASKET.position.get()+3),
