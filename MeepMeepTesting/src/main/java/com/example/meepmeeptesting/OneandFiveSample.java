...
public class OneandFiveSample {
    public static void main(String[] args) {
        ...
        final Pose2d scorePose = new Pose2d(7, -34, Math.toRadians(120));
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                //TrajectoryActionBuilder driveToEject = driveToScorePreload.endTrajectory().fresh()
                        ...
                        .splineToSplineHeading(new Pose2d(25, -45, Math.toRadians(140)), Math.toRadians(0))
                ...
                //TrajectoryActionBuilder turnRobot = driveToPush1.endTrajectory().fresh()
                        ...
                        .splineToLinearHeading(new Pose2d(35.8, -48, Math.toRadians(150)), Math.toRadians(240))
                ...
                //TrajectoryActionBuilder turnRobot2 = driveToPush2.endTrajectory().fresh()
                        ...
                        .splineToLinearHeading(new Pose2d(45.8, -48, Math.toRadians(150)), Math.toRadians(250))
                ...
                //TrajectoryActionBuilder driveToScoreFirstSpecimen = driveToIntakeFirstSpecimen.endTrajectory().fresh()
                        ...
                        .splineToSplineHeading(new Pose2d(9,-34,Math.toRadians(120)), Math.toRadians(tangentsToScoreSpecimen-20))
