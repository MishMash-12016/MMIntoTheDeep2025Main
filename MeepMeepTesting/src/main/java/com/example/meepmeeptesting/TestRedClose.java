...
public class TestRedClose {
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .splineToLinearHeading(new Pose2d(-51.8, -58, Math.toRadians(215)), Math.toRadians(250)) //score high sample
                ...
                .splineToLinearHeading(new Pose2d(-57.875, -50.84, Math.toRadians(270)), Math.toRadians(100)) // pick up 2
                        ...
                        .splineToLinearHeading(new Pose2d(-51.8, -58, Math.toRadians(215)), Math.toRadians(300)) //score
