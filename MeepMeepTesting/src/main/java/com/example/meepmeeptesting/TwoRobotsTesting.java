...
public class TwoRobotsTesting {
    public static void main(String[] args) {
        ...
        myBlueBot.runAction(myBlueBot.getDrive().actionBuilder (new Pose2d(5.5, 65.5, Math.toRadians(90.00)))
        ...
        myRedBot.runAction(myRedBot.getDrive().actionBuilder (new Pose2d(-5.5, -65.5, Math.toRadians(90.00)))
